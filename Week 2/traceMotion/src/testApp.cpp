...
void testApp::draw(){
    ...
    ofDrawBitmapStringHighlight("Press 1, 2, or 3 to change video", ofPoint(20,20));
}
...
void testApp::keyPressed(int key){
    ...
    if (key == '1') video.loadMovie("1.mov");
    if (key == '2') video.loadMovie("2.mov");
    if (key == '3') video.loadMovie("3.mov");
}
